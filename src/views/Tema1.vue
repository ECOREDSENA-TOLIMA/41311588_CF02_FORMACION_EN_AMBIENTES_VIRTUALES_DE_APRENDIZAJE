...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-4
    ...
    .row.justify-content-center.mb-4(data-aos="flip-up")
      .col-lg-12.col-12
        p A continuación, se ejemplifican las tres modalidades, de acuerdo a las listas de chequeo: 
    ...
    .row.justify-content-center(data-aos="flip-up")
      ...
      .col-lg-10.col-12.desktop
        ImagenInfografica.color-acento-botones.mb-4
          ...
          div(x="14%" y="85%" tooltip="Asignación del curso" numero="+")(style="background-color:#EEFFE9;padding:10px;border-radius:10px")
            
            p.p-3 Cuando el instructor recibe el o los cursos que debe orientar, estos son asignados por el coordinador académico del centro de formación, de acuerdo con el diseño curricular y el perfil profesional del instructor, la asignación es mensual o de acuerdo con la intensidad horaria.
          div(x="37%" y="85%" tooltip="Asignación del curso" numero="+")(style="background-color:#EEFFE9;padding:10px;border-radius:10px")
            
            p.p-3 El instructor configura y edita el LMS, prepara y verifica todo el material, documentos y enlaces. También, realiza la planeación del proceso, a través del cronograma de actividades.
          div(x="58%" y="85%" tooltip="Asignación del curso" numero="+")(style="background-color:#EEFFE9;padding:10px;border-radius:10px")
            
            p.p-3 El instructor guía, retroalimenta y se comunica con el aprendiz para orientar las temáticas del curso y el manejo de las herramientas de LMS. Este momento comprende la mayor parte del tiempo del proceso formativo.
          div(x="81%" y="85%" tooltip="Asignación del curso" numero="+")(style="background-color:#EEFFE9;padding:10px;border-radius:10px")
            
            p.p-3 El instructor evalúa a través del centro de calificaciones, hace seguimiento y realiza los diferentes reportes del LMS y SOFIA Plus.
